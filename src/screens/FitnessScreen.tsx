...
export default function FitnessScreen() {
  ...
  const [activeTab, setActiveTab] = useState<"hoy" | "rutinas" | "biblioteca">(
    "hoy",
  );
  ...
  const [showLibMuscleModal, setShowLibMuscleModal] = useState(false);
  ...
  const handlePickImage = async () => {
    ...
    if (!result.canceled) {
      ...
      if (asset.base64) {
        ...
        const mimeType = finalUri?.endsWith(".png")
          ? "image/png"
          : "image/jpeg";
  ...
  const handleSaveLibraryDb = async () => {
    const finalMuscleStr = selectedMuscles.join(", ");
    if (!libName || !finalMuscleStr) {
      Alert.alert(
        "Faltan datos",
        "Completa nombre y selecciona al menos un grupo muscular.",
      );
      return;
    }
      ...
      [
        { text: "Cancelar", style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            Alert.alert(
              "Eliminado",
              "El ejercicio ha sido borrado de tu biblioteca.",
            );
          },
        },
      ],
  ...
  const handleAddExerciseToToday = (
  ...
  const handleUpdateTodayExercise = (
    exerciseId: string,
    field: "weight" | "reps" | "sets",
    value: string,
  ) => {
    setTodaysExercises(
      todaysExercises.map((e) =>
  ...
  const handleRemoveTodayExercise = (exerciseId: string) => {
    setTodaysExercises(
      todaysExercises.filter((e) => e.exerciseId !== exerciseId),
    );
  };
  ...
  const handleSaveTodaysSession = async () => {
    if (todaysExercises.length === 0) {
      Alert.alert(
        "Nada para guardar",
        "Agrega al menos un ejercicio para registrar el entrenamiento de hoy.",
      );
      return;
    }

    const validExs = todaysExercises.map((e) => ({
    ...
    if (editingSessionId) {
      ...
      updateWorkoutSession({
        id: editingSessionId,
        date: todayStr,
        routineName: "Entrenamiento de Hoy",
        durationMinutes: 0,
        exercises: validExs,
      });
    ...
    if (!wasTrained) {
      try {
        ...
        Alert.alert(
          "Guardado",
          `Entrenamiento del día guardado en historial. +${amount} créditos`,
        );
      } catch (e) {
      ...
      Alert.alert(
        "Guardado",
        "Entrenamiento del día actualizado en historial.",
      );
    }
      ...
      <View style={styles.tabsRow}>
        ...
        >
          ...
          <Text
            style={[
              styles.tabBtnText,
              activeTab === "hoy" && styles.tabBtnTextActive,
            ]}
            numberOfLines={1}
        ...
        <TouchableOpacity
          ...
          style={[
            styles.tabBtn,
            activeTab === "rutinas" && styles.tabBtnActive,
          ]}
        >
          <List
            size={20}
          ...
          <Text
            style={[
              styles.tabBtnText,
              activeTab === "rutinas" && styles.tabBtnTextActive,
            ]}
          >
            Rutinas
          </Text>
        ...
        <TouchableOpacity
          ...
          style={[
            styles.tabBtn,
            activeTab === "biblioteca" && styles.tabBtnActive,
          ]}
        >
          <Plus
            size={20}
          ...
          <Text
            style={[
              styles.tabBtnText,
              activeTab === "biblioteca" && styles.tabBtnTextActive,
            ]}
          >
            Biblioteca
          </Text>
          ...
          <>
            ...
            <View style={styles.card}>
              ...
              {(weightLogs || []).length > 0 && (
                <Text style={styles.subtext}>
                  Último registro: {weightLogs[0].weight}kg (
                  {weightLogs[0].date})
                </Text>
              )}
            </View>
            ...
            <View style={styles.card}>
              ...
              >
                ...
                {(routines || []).length > 0 && (
                  <TouchableOpacity
                    style={[styles.smallOutlineBtn, { marginBottom: 8 }]}
                    onPress={() => setShowLoadRoutineModal(true)}
                  >
                ...
                >
                  ...
                  >
                      ...
                      {(routines || []).map((r) => (
                          ...
                          onPress={() => {
                            ...
                            (r.exerciseIds || []).forEach((id) => {
                              ...
                              if (ex) {
                                ...
                                handleAddExerciseToToday(
                                  ex,
                                  recent ? recent.weight.toString() : "",
                                  recent ? recent.reps.toString() : "",
                                  recent ? recent.sets.toString() : "",
                                );
                              }
                            });
                        ...
                        >
                          <Text style={styles.routineChipText}>
                            {r.name} ({(r.exerciseIds || []).length} ej.)
                          </Text>
                        </TouchableOpacity>
                      ))}
                    </ScrollView>
                    <TouchableOpacity
                      ...
                      onPress={() => setShowLoadRoutineModal(false)}
                    >
              ...
              <Text style={[styles.label, { marginBottom: 8, marginTop: 12 }]}>
                Seleccionar por grupo muscular:
              </Text>
              {(exerciseLibrary || []).length === 0 && (
                <Text style={styles.subtext}>
                  Agrega ejercicios en la Biblioteca primero.
                </Text>
              )}
              ...
              <View style={{ marginBottom: 12, paddingHorizontal: 4 }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <ScrollView>
                        {Array.from(
                          new Set(
                            (exerciseLibrary || []).flatMap((e) =>
                              (e.muscleGroup || "Otros").split(",").map((m) => {
                                const val = m.trim();
                                return (
                ...
                {selectedMuscle && (
                  <View style={{ marginTop: 8 }}>
                    {(exerciseLibrary || [])
                      .filter((ex) =>
                        (ex.muscleGroup || "Otros")
                          .split(",")
                          .map((m) => {
                            const val = m.trim();
                            return val.charAt(0).toUpperCase() + val.slice(1);
                          })
                          .includes(selectedMuscle),
                      )
                      .map((ex) => (
                        <View
                          key={ex.id}
                        ...
                        >
                          ...
                          <TouchableOpacity
                            ...
                            onPress={() => handleAddExerciseToToday(ex)}
                          >
              ...
              {todaysExercises.length > 0 && (
                <View style={{ marginTop: 8, paddingHorizontal: 4 }}>
                  {todaysExercises.map((ex) => (
                    ...
                    >
                      <Text style={{ flex: 0.8, ...styles.advExName }}>
                        {ex.name}
                      </Text>
                      <View
                      ...
                      >
                        <TextInput
                          ...
                          placeholder="Peso"
                          keyboardType="numeric"
                          style={[styles.smallInput, { width: 65 }]}
                        />
                        <TextInput
                          value={ex.sets}
                          onChangeText={(v) =>
                            handleUpdateTodayExercise(ex.exerciseId, "sets", v)
                          }
                          placeholder="Series"
                          keyboardType="numeric"
                          style={[
                            styles.smallInput,
                            { width: 60, marginLeft: 6 },
                          ]}
                        />
                        <TextInput
                          value={ex.reps}
                          onChangeText={(v) =>
                            handleUpdateTodayExercise(ex.exerciseId, "reps", v)
                          }
                          placeholder="Reps"
                          keyboardType="numeric"
                          style={[
                        ...
                        <TouchableOpacity
                          onPress={() =>
                            handleRemoveTodayExercise(ex.exerciseId)
                          }
                          style={{ marginLeft: 8 }}
                        >
                  ...
                  {editingSessionId && (
                    <Text
                      style={[
                        styles.subtext,
                        { marginBottom: 8, color: theme.colors.primary },
                      ]}
                    >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={handleSaveTodaysSession}
                  >
                ...
                <View style={{ marginBottom: 16 }}>
                  {routineExercises.map((id) => {
                    ...
                    return (
                      ...
                      >
                        <Text style={{ flex: 1, ...styles.libName }}>
                          {ex.name}
                        </Text>
                        <TouchableOpacity
                          onPress={() =>
                            setRoutineExercises(
                              routineExercises.filter((eId) => eId !== id),
                            )
                          }
                        >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <ScrollView>
                      {(() => {
                        const grouped = (exerciseLibrary || []).reduce(
                          (acc: Record<string, ExerciseLibraryItem[]>, ex) => {
                            const groups = ex.muscleGroup
                              ? ex.muscleGroup
                                  .split(",")
                                  .map((m) => m.trim().toUpperCase() || "OTROS")
                              : ["OTROS"];
                          ...
                          .map((muscle) => (
                            ...
                            >
                              ...
                              {grouped[muscle].map((ex) => {
                                const isSelected = routineExercises.includes(
                                  ex.id,
                                );
                                return (
                                  <TouchableOpacity
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (!routineName.trim() || routineExercises.length === 0) {
                    Alert.alert(
                      "Faltan datos",
                      "Ponle un nombre a tu rutina y selecciona al menos un ejercicio.",
                    );
                    return;
                  }
                  if (editingRoutineId) {
              ...
              <View>
                ...
                {(routines || []).map((r) => (
                  ...
                  >
                    ...
                    <Text style={styles.subtext}>
                      {(r.exerciseIds || []).length} ejercicios
                    </Text>
                    <View
                      style={{
                        flexDirection: "row",
          ...
          <>
            <View style={styles.card}>
              ...
              <TouchableOpacity
                ...
                onPress={() => setShowLibMuscleModal(true)}
              >
                <Text
                  style={{
                    color:
                  ...
                  >
                          ...
                          return (
                            <TouchableOpacity
                              ...
                              onPress={() => {
                                if (isSelected)
                                  setSelectedMuscles(
                                    selectedMuscles.filter((m) => m !== group),
                                  );
                                else
                                  setSelectedMuscles([
                                    ...selectedMuscles,
                            ...
                            >
                              <View style={styles.libInfo}>
                                <Text style={styles.libName}>{group}</Text>
                              </View>
                              {isSelected && (
                    ...
                    >
                      <TextInput
                        ...
                        onChangeText={setNewMuscleInput}
                      />
                      <TouchableOpacity
                        style={styles.smallBtn}
                        onPress={() => {
                          const val = newMuscleInput.trim();
                          if (val) {
                            addCustomMuscleGroup(val);
                            if (!selectedMuscles.includes(val)) {
                              setSelectedMuscles([...selectedMuscles, val]);
                            }
                            setNewMuscleInput("");
                          }
                        }}
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => setShowLibMuscleModal(false)}
                    >
                      <Text style={styles.submitBtnText}>Aceptar</Text>
                    </TouchableOpacity>
                  </View>
              ...
              >
                ...
                <Text style={styles.outlineBtnText}>
                  {libImage ? "Cambiar Imagen" : "Elegir Imagen de Galería"}
                </Text>
              </TouchableOpacity>
              {libImage && (
            ...
            {!editingExercise && (
              <>
                ...
                >
                  Mi Biblioteca ({exerciseLibrary?.length || 0})
                </Text>
                <Text
                  style={[styles.subtext, { marginLeft: 5, marginBottom: 10 }]}
                >
                  Toca un ejercicio para ver sus detalles o editarlo.
                </Text>
                              ...
                              <View style={styles.libInfo}>
                                ...
                                {recent ? (
                                  <Text style={styles.libRecent}>
                                    Última vez: {recent.weight}kg |{" "}
                                    {recent.sets}x{recent.reps} ({recent.date})
                                  </Text>
                                ) : (
                                  <Text style={styles.libRecent}>
